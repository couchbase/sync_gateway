...
// Package changesfeedtest holds the db-level tests for the changes feed - changes.go,
// changes_view.go and sequence_id.go. Split out of package db so the changes feed can be
