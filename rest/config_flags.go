...
func registerConfigFlags(config *StartupConfig, fs *flag.FlagSet) map[string]configFlag {
	return map[string]configFlag{
		...
		"logging.console.rotation.max_size":                {&config.Logging.Console.ConfigRotation.MaxSize, fs.Int("logging.console.rotation.max_size", 0, "")},
		"logging.console.rotation.max_age":                 {&config.Logging.Console.ConfigRotation.MaxAge, fs.Int("logging.console.rotation.max_age", 0, "")},
		"logging.console.rotation.localtime":               {&config.Logging.Console.ConfigRotation.LocalTime, fs.Bool("logging.console.rotation.localtime", false, "")},
		"logging.console.rotation.rotated_logs_size_limit": {&config.Logging.Console.ConfigRotation.RotatedLogsSizeLimit, fs.Int("logging.console.rotation.rotated_logs_size_limit", 0, "")},
		...
		"logging.error.rotation.max_size":                {&config.Logging.Error.ConfigRotation.MaxSize, fs.Int("logging.error.rotation.max_size", 0, "")},
		"logging.error.rotation.max_age":                 {&config.Logging.Error.ConfigRotation.MaxAge, fs.Int("logging.error.rotation.max_age", 0, "")},
		"logging.error.rotation.localtime":               {&config.Logging.Error.ConfigRotation.LocalTime, fs.Bool("logging.error.rotation.localtime", false, "")},
		"logging.error.rotation.rotated_logs_size_limit": {&config.Logging.Error.ConfigRotation.RotatedLogsSizeLimit, fs.Int("logging.error.rotation.rotated_logs_size_limit", 0, "")},
		...
		"logging.warn.rotation.max_size":                {&config.Logging.Warn.ConfigRotation.MaxSize, fs.Int("logging.warn.rotation.max_size", 0, "")},
		"logging.warn.rotation.max_age":                 {&config.Logging.Warn.ConfigRotation.MaxAge, fs.Int("logging.warn.rotation.max_age", 0, "")},
		"logging.warn.rotation.localtime":               {&config.Logging.Warn.ConfigRotation.LocalTime, fs.Bool("logging.warn.rotation.localtime", false, "")},
		"logging.warn.rotation.rotated_logs_size_limit": {&config.Logging.Warn.ConfigRotation.RotatedLogsSizeLimit, fs.Int("logging.warn.rotation.rotated_logs_size_limit", 0, "")},
		...
		"logging.info.rotation.max_size":                {&config.Logging.Info.ConfigRotation.MaxSize, fs.Int("logging.info.rotation.max_size", 0, "")},
		"logging.info.rotation.max_age":                 {&config.Logging.Info.ConfigRotation.MaxAge, fs.Int("logging.info.rotation.max_age", 0, "")},
		"logging.info.rotation.localtime":               {&config.Logging.Info.ConfigRotation.LocalTime, fs.Bool("logging.info.rotation.localtime", false, "")},
		"logging.info.rotation.rotated_logs_size_limit": {&config.Logging.Info.ConfigRotation.RotatedLogsSizeLimit, fs.Int("logging.info.rotation.rotated_logs_size_limit", 0, "")},
		...
		"logging.debug.rotation.max_size":                {&config.Logging.Debug.ConfigRotation.MaxSize, fs.Int("logging.debug.rotation.max_size", 0, "")},
		"logging.debug.rotation.max_age":                 {&config.Logging.Debug.ConfigRotation.MaxAge, fs.Int("logging.debug.rotation.max_age", 0, "")},
		"logging.debug.rotation.localtime":               {&config.Logging.Debug.ConfigRotation.LocalTime, fs.Bool("logging.debug.rotation.localtime", false, "")},
		"logging.debug.rotation.rotated_logs_size_limit": {&config.Logging.Debug.ConfigRotation.RotatedLogsSizeLimit, fs.Int("logging.debug.rotation.rotated_logs_size_limit", 0, "")},
		...
		"logging.trace.rotation.max_size":                {&config.Logging.Trace.ConfigRotation.MaxSize, fs.Int("logging.trace.rotation.max_size", 0, "")},
		"logging.trace.rotation.max_age":                 {&config.Logging.Trace.ConfigRotation.MaxAge, fs.Int("logging.trace.rotation.max_age", 0, "")},
		"logging.trace.rotation.localtime":               {&config.Logging.Trace.ConfigRotation.LocalTime, fs.Bool("logging.trace.rotation.localtime", false, "")},
		"logging.trace.rotation.rotated_logs_size_limit": {&config.Logging.Trace.ConfigRotation.RotatedLogsSizeLimit, fs.Int("logging.trace.rotation.rotated_logs_size_limit", 0, "")},
		...
		"logging.stats.rotation.max_size":                {&config.Logging.Stats.ConfigRotation.MaxSize, fs.Int("logging.stats.rotation.max_size", 0, "")},
		"logging.stats.rotation.max_age":                 {&config.Logging.Stats.ConfigRotation.MaxAge, fs.Int("logging.stats.rotation.max_age", 0, "")},
		"logging.stats.rotation.localtime":               {&config.Logging.Stats.ConfigRotation.LocalTime, fs.Bool("logging.stats.rotation.localtime", false, "")},
