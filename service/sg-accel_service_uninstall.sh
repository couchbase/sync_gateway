...
usage()
{
    echo "This script removes an init service to run a sg-accel instance."
}
...
case $OS in
    ...
    Darwin)
        ...
        if [ -f /Library/LaunchDaemons/com.couchbase.mobile.sg-accel.plist ]; then
        	rm /Library/LaunchDaemons/com.couchbase.mobile.sg-accel.plist
        fi
        ;;
    *)
