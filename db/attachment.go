...
func (db *Database) retrieveAncestorAttachments(doc *Document, parentRev string, docHistory []string) map[string]interface{} {
	...
	if parent != nil {
		parentAttachments = parent.Attachments
	} else {
...
func (db *Database) ForEachStubAttachment(attachments AttachmentsMeta, minRevpos int, callback AttachmentCallback) error {
