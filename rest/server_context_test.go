...
func TestGetOrAddDatabaseFromConfig(t *testing.T) {
	...
	assert.Contains(t, err.Error(), "400 Illegal database name")
	...
	assert.Contains(t, err.Error(), "Unrecognized value for import_docs")
	...
	assert.Contains(t, err.Error(), "412 Duplicate database name")
