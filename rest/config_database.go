	...
	dbConfig := DbConfig{
		...
		CacheConfig: &CacheConfig{
			...
			ChannelCacheConfig: &ChannelCacheConfig{
				...
				DeprecatedQueryLimit: base.IntPtr(db.DefaultQueryPaginationLimit),
			},
		},
		DeprecatedRevCacheSize:    base.Uint32Ptr(db.DefaultRevisionCacheSize),
