...
type UnsupportedConfig struct {
	...
	AllowScopesInPersistentConfig *bool                `json:"allow_scopes_in_persistent_config,omitempty"` // Allow scopes in persistent config, not supported for multiple databases with different collections targeting the same bucket
}
