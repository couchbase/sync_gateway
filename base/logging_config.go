...
type LegacyLoggingConfig struct {
	...
	Console        ConsoleLoggerConfig `json:"console"`                   // Console output
	Error          FileLoggerConfig    `json:"error"`                     // Error log file output
	Warn           FileLoggerConfig    `json:"warn"`                      // Warn log file output
	Info           FileLoggerConfig    `json:"info"`                      // Info log file output
	Debug          FileLoggerConfig    `json:"debug"`                     // Debug log file output
	Trace          FileLoggerConfig    `json:"trace"`                     // Trace log file output
	Stats          FileLoggerConfig    `json:"stats"`                     // Stats log file output
}
