			...
			for i, changesReq := range changesReqs {
				...
				if btc.UseHLV() {
					...
					if localHLV == nil {
						...
						base.DebugfCtx(ctx, base.KeySGTest, "Skipping changes for incoming doc %q with for version %#v as we already have a newer version %#v",
							docID, changesVersion, localHLV)
