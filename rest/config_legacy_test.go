...
func TestLegacyConfigToStartupConfig(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			input:    LegacyServerConfig{Unsupported: &UnsupportedServerConfigLegacy{StatsLogFrequencySecs: new(uint(10))}},
		...
		},
		{
			...
			input:    LegacyServerConfig{ServerReadTimeout: new(0)},
		...
		},
		{
			...
			input:    LegacyServerConfig{ServerWriteTimeout: new(30)},
		...
		},
		{
			...
			base:     StartupConfig{API: APIConfig{Pretty: new(true)}},
			input:    LegacyServerConfig{Pretty: false},
			expected: StartupConfig{API: APIConfig{Pretty: new(true)}},
		},
		{
			name:     "Override *bool(false) CompressResponses",
			base:     StartupConfig{API: APIConfig{CompressResponses: new(true)}},
			input:    LegacyServerConfig{CompressResponses: new(false)},
			expected: StartupConfig{API: APIConfig{CompressResponses: new(false)}},
		},
		{
			name:     "Override nil *bool HTTP2Enable",
			base:     StartupConfig{},
			input:    LegacyServerConfig{Unsupported: &UnsupportedServerConfigLegacy{Http2Config: &HTTP2Config{Enabled: new(false)}}},
			expected: StartupConfig{Unsupported: UnsupportedConfig{HTTP2: &HTTP2Config{Enabled: new(false)}}},
		},
		{
			name:     "Absent property AdminInterfaceAuthentication",
			base:     StartupConfig{API: APIConfig{AdminInterfaceAuthentication: new(true)}},
			input:    LegacyServerConfig{},
			expected: StartupConfig{API: APIConfig{AdminInterfaceAuthentication: new(true)}},
		},
		{
			name:     "http:// to couchbase://",
			base:     StartupConfig{},
			input:    LegacyServerConfig{Databases: DbConfigMap{"db": &DbConfig{BucketConfig: BucketConfig{Server: new("http://http.couchbase.com:8091,host2:8091,host1,[2001:db8::8811],[2001:db8::8822]:8091")}}}},
		...
		},
		{
			...
			base:     StartupConfig{},
			input:    LegacyServerConfig{Databases: DbConfigMap{"db": &DbConfig{BucketConfig: BucketConfig{Server: new("http://foo:bar@[2001:db8::8811]:8091,host2")}}}},
		...
		},
		{
			...
			base:     StartupConfig{},
			input:    LegacyServerConfig{Databases: DbConfigMap{"db": &DbConfig{BucketConfig: BucketConfig{Server: new("couchbase://host1:123,host2:9911?test=true")}}}},
		...
		},
		{
			...
			base:     StartupConfig{},
			input:    LegacyServerConfig{Databases: DbConfigMap{"db": &DbConfig{BucketConfig: BucketConfig{Server: new("couchbase://foo:bar@host1:123"), Username: "usr", Password: "pass"}}}},
		...
		},
		{
			...
			base:     StartupConfig{},
			input:    LegacyServerConfig{Databases: DbConfigMap{"db": &DbConfig{BucketConfig: BucketConfig{Server: new("http://host1,host2:8091?p1=v1&p2=v2&p3=v3")}}}},
...
func TestLegacyConfigPrinciplesMigration(t *testing.T) {
	...
	existingUsers := map[string]*auth.PrincipalConfig{
		"ExistingUserStatic": {
			Name:             new("ExistingUserStatic"),
			ExplicitChannels: base.SetOf("*"),
		},
		"ExistingUser": {
			Name:             new("ExistingUser"),
			ExplicitChannels: base.SetOf("*"),
		},
	}
	...
	existingRoles := map[string]*auth.PrincipalConfig{
		"ExistingRoleStatic": {
			Name:             new("ExistingRoleStatic"),
			ExplicitChannels: base.SetOf("*"),
		},
		"ExistingRole": {
			Name:             new("ExistingRole"),
			ExplicitChannels: base.SetOf("*"),
		},
	}
	...
	authenticator := auth.NewAuthenticator(bucket.DefaultDataStore(ctx), nil, rt.GetDatabase().AuthenticatorOptions(ctx))
