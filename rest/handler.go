...
func (h *handler) removeCorruptConfigIfExists(bucket, configGroupID, dbName string) error {
	...
	err := h.server.bootstrapContext.connection.DeleteConfig(bucket, configGroupID)
	if err != nil {
		return err
	}
