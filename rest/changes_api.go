...
func (h *handler) handleChanges() error {
	...
	base.UpdateDbStat(h.getStatPrefix(), "changesFeeds_total", 1)
	base.UpdateDbStat(h.getStatPrefix(), "changesFeeds_active", 1)
	defer base.UpdateDbStat(h.getStatPrefix(), "changesFeeds_active", -1)
