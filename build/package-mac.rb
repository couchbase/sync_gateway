...
echo "DEBUG:  0: PREFIX          = ${PREFIX}"
echo "DEBUG:  1: PREFIXD         = ${PREFIXD}"
echo "DEBUG:  2: PRODUCT_VERSION = ${PRODUCT_VERSION}"
echo "DEBUG:  3: REPO_SHA        = ${REPO_SHA}"
echo "DEBUG:  4: PLATFORM        = ${PLATFORM}"
echo "DEBUG:  5: ARCH            = ${ARCH}"
echo " "
echo "DEBUG:  RELEASE            = ${RELEASE}"
echo "DEBUG:  BLDNUM             = ${BLDNUM}"
echo " "
echo "DEBUG:  PKGNAME = ${PKGNAME}"
echo " "
