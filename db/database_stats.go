...
func NewDatabaseStats(dbName string) *DatabaseStats {
	...
	c = &base.Collector{
		...
		Info: map[string]base.StatComponents{
			...
			base.StatKeyChannelCacheCompactTime:             {ValueType: prometheus.CounterValue},
	...
	c = &base.Collector{
		...
		Info: map[string]base.StatComponents{
			...
			base.StatKeyNumTombstonesCompacted:  {ValueType: prometheus.CounterValue},
			base.StatKeySequenceAssignedCount:   {ValueType: prometheus.CounterValue},
			base.StatKeySequenceGetCount:        {ValueType: prometheus.CounterValue},
			base.StatKeySequenceIncrCount:       {ValueType: prometheus.CounterValue},
