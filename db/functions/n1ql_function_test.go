...
func testUserQueriesCommon(t *testing.T, ctx context.Context, db *db.Database) {
	...
	assertErrorContains(t, err, "numero")
	...
	assertErrorContains(t, err, "syntax_error")
}
...
func TestUserN1QLQueriesInvalid(t *testing.T) {
	...
	assertErrorContains(t, err, "only SELECT queries are allowed") // See fn validateN1QLQuery
