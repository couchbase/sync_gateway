...
func WriteCasWithXattr(store *Collection, k string, xattrKey string, exp uint32, cas uint64, opts *sgbucket.MutateInOptions, v interface{}, xv interface{}) (casOut uint64, err error) {
...
func SetXattr(store *Collection, k string, xattrKey string, xv []byte) (casOut uint64, err error) {
...
func RemoveXattr(store *Collection, k string, xattrKey string, cas uint64) error {
...
// straight delete.
func DeleteXattrs(store *Collection, k string, xattrKeys ...string) error {
	worker := func() (shouldRetry bool, err error, value interface{}) {
...
func DeleteWithXattr(store *Collection, k string, xattrKey string) error {
...
func deleteWithXattrInternal(store *Collection, k string, xattrKey string, callback deleteWithXattrRaceInjection) error {
