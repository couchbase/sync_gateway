...
func TestRevisionStorageConflictAndTombstones(t *testing.T) {
	...
	_, _, err = db.PutExistingRevWithBody("doc1", rev2a_body, []string{"2-a", "1-a"}, false)
	...
	_, _, err = db.PutExistingRevWithBody("doc1", rev3b_body, []string{"3-b", "2-b"}, false)
	...
	_, _, err = db.PutExistingRevWithBody("doc1", rev2c_body, []string{"2-c", "1-a"}, false)
	...
	_, _, err = db.PutExistingRevWithBody("doc1", rev3c_body, []string{"3-c", "2-c"}, false)
...
func TestOldRevisionStorage(t *testing.T) {
	...
	_, _, err = db.PutExistingRevWithBody("doc1", rev3a_body, []string{"3-a", "2-a", "1-a"}, false)
	assert.NoError(t, err, "add 3-a")
	...
	_, _, err = db.PutExistingRevWithBody("doc1", rev6a_body, []string{"6-a", "5-a", "4-a", "3-a"}, false)
	assert.NoError(t, err, "add 6-a")
