...
type ServerConfig struct {
	...
	HideProductInfo            bool                     `json:"hide_product_info,omitempty"`      // Determines whether product information (name and version) are removed from Server headers and REST API responses. This setting does not apply to the Admin REST API.
}
