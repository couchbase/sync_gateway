...
func (rc *BypassRevisionCache) Get(docID, revID string) (docRev *DocumentRevision, err error) {
	...
	docRev.RevID = revID
	docRev.Body, docRev.History, docRev.Channels, docRev.Attachments, docRev.Expiry, docRev.Deleted, err = revCacheLoader(rc.backingStore, IDAndRev{DocID: docID, RevID: revID})
	if err != nil {
...
func (rc *BypassRevisionCache) GetActive(docID string) (docRev *DocumentRevision, err error) {
	...
	docRev.Body, docRev.History, docRev.Channels, docRev.Attachments, docRev.Expiry, docRev.Deleted, err = revCacheLoaderForDocument(rc.backingStore, doc, doc.SyncData.CurrentRev)
	if err != nil {
		return &DocumentRevision{}, err
	}
