...
type RevisionCache interface {
	...
	// When includeDelta=true, the returned DocumentRevision will include delta - requires additional locking during retrieval.
	GetWithCV(ctx context.Context, docID string, cv *SourceAndVersion, collectionID uint32, includeDelta bool) (DocumentRevision, error)
	...
	RemoveWithCV(docID string, cv *SourceAndVersion, collectionID uint32)
...
// Get is for per collection access to Get method
func (c *collectionRevisionCache) GetWithCV(ctx context.Context, docID string, cv *SourceAndVersion, includeDelta bool) (DocumentRevision, error) {
...
func (c *collectionRevisionCache) RemoveWithCV(docID string, cv *SourceAndVersion) {
...
func revCacheLoader(ctx context.Context, backingStore RevisionCacheBackingStore, id IDAndRev) (bodyBytes []byte, history Revisions, channels base.Set, removed bool, attachments AttachmentsMeta, deleted bool, expiry *time.Time, fetchedCV *SourceAndVersion, err error) {
	var doc *Document
...
func revCacheLoaderForDocument(ctx context.Context, backingStore RevisionCacheBackingStore, doc *Document, revid string) (bodyBytes []byte, history Revisions, channels base.Set, removed bool, attachments AttachmentsMeta, deleted bool, expiry *time.Time, fetchedCV *SourceAndVersion, err error) {
...
func revCacheLoaderForDocumentCV(ctx context.Context, backingStore RevisionCacheBackingStore, doc *Document, cv SourceAndVersion) (bodyBytes []byte, history Revisions, channels base.Set, removed bool, attachments AttachmentsMeta, deleted bool, expiry *time.Time, revid string, err error) {
