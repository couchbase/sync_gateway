...
func TestSyncFuncDryRun(t *testing.T) {
	...
	base.SetUpTestLogging(t, base.LevelDebug, base.KeyCRUD, base.KeyChanges, base.KeyJavascript, base.KeyHTTP)
...
func TestImportFilterDryRun(t *testing.T) {
	db.DisableSequenceWaitOnDbRestart(t)
	base.SetUpTestLogging(t, base.LevelDebug, base.KeyCRUD, base.KeyChanges, base.KeyJavascript, base.KeyHTTP, base.KeyImport)
