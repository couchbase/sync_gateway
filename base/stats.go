...
const (
	...
	StatAddedVersion4dot2dot0     = "4.2.0"
...
func (d *DbStats) initDatabaseStats() error {
	...
	resUtil.InvalidRevTreeCount, err = NewIntStat(SubsystemDatabaseKey, "invalid_rev_tree_count", StatUnitNoUnits, InvalidRevTreeCountDesc, StatAddedVersion4dot2dot0, StatDeprecatedVersionNotDeprecated, StatStabilityInternal, labelKeys, labelVals, prometheus.CounterValue, 0)
	if err != nil {
		return err
	}
